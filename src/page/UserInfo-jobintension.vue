    ...
    <form class="cui-form cui-heade-margin">
      ...
      <div class="userinfo-form">
        <a href="javascript:void(0);" class="cui-input">
          <label>求职状态</label>
          <div class="userinfo-job-status">
            <label>
              <div class="cui-radio">
                <input type="radio" name="test" value="1" class="cui-radio-input">
                <div class="cui-radio-btn"></div>
              </div>
              <span>在职</span>
            </label>
            <label>
              <div class="cui-radio">
                <input type="radio" name="test" value="2" class="cui-radio-input">
                <div class="cui-radio-btn"></div>
              </div>
              <span>离职</span>
            </label>
        ...
        <a  href="javascript:void(0);" class="cui-input cui-input-link">
          <label>参加工作时间</label>
          <div class="userinfo-job-time">
            <input  type="text" placeholder="开始时间">
            <div class="job-time-to">至</div>
            <input  type="text" placeholder="结束时间">
          </div>
        </a>
      </div>
      <div class="cui-btn cui-btn-primary cui-btn-block cui-btn-radius next-btn" @click="register()">下一步</div>
    </form>
  </div>
</template>
<script>
...
<style scoped>
  ...
  .userinfo-job-status,.userinfo-job-time
  {
    height:2.1rem;
    width:100%;
    line-height: 2.1rem;
  ...
  .userinfo-job-status span
  {
    font-size:.8rem;
  }
  .userinfo-job-status .cui-radio
  {
    vertical-align: top;
  }
  .userinfo-job-status input
  {
